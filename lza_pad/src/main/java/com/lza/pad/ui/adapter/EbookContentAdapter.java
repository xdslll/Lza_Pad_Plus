 ...
 * @Date 14-9-18.
 */
public class EbookContentAdapter extends BaseAdapter {
    ...
    private int[] mTag = new int[] {
            ...
            //R.string.ebook_content_tag_comment
    };
    private Context mContext;
    private Ebook mEbook;
    private List<EbookContent> mEbookContents;

    public EbookContentAdapter(Context context, Ebook ebook, List<EbookContent> ebookContents) {
